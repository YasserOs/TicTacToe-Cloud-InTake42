...
public class MultiPlayerController extends GeneralController implements Initializable {
    ...
    public void initSession(String p2 , boolean isInvited ) throws IOException, ClassNotFoundException, JSONException{
    ...
    public void playerWin() throws InterruptedException, IOException, JSONException{
